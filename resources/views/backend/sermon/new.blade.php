                                ...
                                <div class="row" style="margin: 10px">
                                    <data>
                                        <div class="row service">
                                            ...
                                            <div class="form-group">
                                                <b>Period:  </b>
                                                <input type="text" name="period" id="serviceDate" required class="form-control">
                                            </div>
                                        </div>
                                        <div class="row quote">
                                            <div class="form-group">
                                        ...
                                        <div class="row monthly">
                                            ...
                                            <div class="form-group">
                                                <b>Period:  </b>
                                                <input type="text" name="period" required id="monthDate" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row yearly">
                                            ...
                                            <div class="form-group">
                                                <b>Period:  </b>
                                                <input type="text" name="period" required id="yearDate" class="form-control">
                                            </div>
                                        </div>
                                    </data>
                                </div>
