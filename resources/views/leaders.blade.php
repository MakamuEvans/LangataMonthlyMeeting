                ...
                <div class="row">
                    <div class="content col-md-8">
                        <div class="content">
                            ...
                            <div class="row" style="text-align: center; border: dotted 2px red;">
                                <div class="row" style="padding-top: 20px;box-shadow: 0 8px 6px -6px black;margin: 20px;border: 1px red solid">
                                    <a href="{{url('leaders/nairobi-yearly-meeting')}}"> Nairobi Yearly Meeting</a><br><br>
                                    <div class="row" style="padding-top: 20px;box-shadow: 0 8px 6px -6px black;margin: 20px;border: 1px red solid">
                                        <a href="{{url('leaders/monthly-meeting')}}"> Monthly Meeting</a><br><br>
                                        <div class="row">
                                            <div class="col-md-3" style="padding-top: 20px;box-shadow: 0 8px 6px -6px black;margin: 20px;border: 1px red solid">
