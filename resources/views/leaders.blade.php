                    ...
                    <div class="content col-md-8">
                        <div class="content">
                            ...
                            <div class="row" style="text-align: center; border: dotted 2px #1F55AB;">
                                <div class="row" style="padding-top: 20px;box-shadow: 0 8px 6px -6px black;margin: 20px;border: 1px #1F55AB solid">
                                    ...
                                    <div class="row" style="padding-top: 20px;box-shadow: 0 8px 6px -6px black;margin: 20px;border: 1px #1F55AB solid">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3" style="padding-top: 20px;box-shadow: 0 8px 6px -6px black;margin: 20px;border: 1px #1F55AB solid">
